...
class ContactEnrichment(Base):
    ...
    hunter_verification_status: Mapped[str | None] = mapped_column(String(50), nullable=True)  # valid, invalid, unknown
    ...
    enrichment_status: Mapped[str] = mapped_column(String(50), nullable=False, default="pending")  # pending, success, failed, not_found
